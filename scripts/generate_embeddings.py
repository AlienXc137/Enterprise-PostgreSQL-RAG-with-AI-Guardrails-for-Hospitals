...
def generate_and_store_embeddings():
    ...
    #Loading BioClinical ModernBERT embedding model
    ...
    with engine.begin() as conn:
        ...
        with tqdm(total=demo_limit, desc="Vectorizing PHI", unit="rows") as pbar:
            ...
            while processed < demo_limit:
                ...
                #Extract strings into a single list for parallel processing
                clinical_texts = []
                ids = []
                for row in batch:
                    components = []
                ...
                #BATCHED ENCODING: Feed the entire list to the model at once!
                ...
                #BULK UPDATE: execute all 250 rows in a single network round-trip
                update_query = text("""
